...
export class FinancaController {
  ...
  ordena(coluna) {
    ...
    else this._listaFinancas.ordena((a, b) => a[coluna] - b[coluna]);
  ...
  filtra(dataFiltrada) {
    console.log("dataFiltrada: ", dataFiltrada.valueOf());
    console.log("Lista finanças: ", this._listaFinancas._financas);
    return this._listaFinancas._financas.filter(
      (financa) =>
